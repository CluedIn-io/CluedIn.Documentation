...
The first option is to visualise this explanation within the user interface by clicking on the "Explain" button when you see a data quality score widget. 
