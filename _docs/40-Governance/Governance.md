...
- [Installing an existing integration](/docs/10-Integration/install-integration.html)
...
There are many *providers* available in our [GitHub](https://github.com/CluedIn-io), but alternatively you can also [build your own](/docs/10-Integration/build-integration.html) to cater for your specific requirements. In order to do this though, you will require some C# coding experience.
...
We have a list of available *enrichers* in our [GitHub](https://github.com/CluedIn-io), but you can also [build your own](/docs/10-Integration/build-enricher.html), as long as you have some C# coding experience. 