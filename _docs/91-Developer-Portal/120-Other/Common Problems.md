...
# Virutal Properties for Models in Crawlers

When you are creating models in your crawlers as to map a source systems structure into a C# model, you will often have a simple POCO that is public and has a type. The virtual keyword in C# is used to specific that this property can be overriden in a base class, however virtual properties are not supported in CluedIn crawlers. 