...
* Filtering on only getting the latest data (delta/auto crawls) - By default, CluedIn runs a job every 4 hours for a new crawl. This should only pull the latest data since the previous crawl. Please refer to [Delta/Auto crawls - Change Data Capture](/docs/10-Integration/delta-crawls.html)
...
* Vocabulary mappings - Is all the data mapped to relevant core vocabularies?
