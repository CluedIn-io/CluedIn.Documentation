...
nav_order: 20
permalink: /develop/python-sdk/search
content_type: how-to
redirect_from: ["/playbooks/data-engineering-playbook/search"]
source_path: docs/210-playbooks/data-engineering/020-search.md
tags: ["python"]
...
You can add GraphQL [Actions](/publish/graphql/graphql-actions) when running GraphQL queries in the Python SDK. Actions are a way to run commands in bulk, such as processing, enriching, or deleting entities.
