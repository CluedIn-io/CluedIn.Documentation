...
nav_order: 30
permalink: /develop/integrations/robust-ntegrations
content_type: concept
redirect_from: ["/integration/robust-ntegrations"]
source_path: docs/040-integration/crawlers/030-robust-integrations.md
tags: ["integration"]
---
...
CluedIn’s crawler framework ships with a [validation framework](/develop/integrations/crawler-validation-framework), which you can extend.
