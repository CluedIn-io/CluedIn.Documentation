...
nav_order: 70
permalink: /operate/deployment-options/azure-policy-exemption
content_type: reference
redirect_from: ["/deployment/azure-policy-exemption"]
source_path: docs/020-deployment/007-licensing-agent-exclusion.md
nav_exclude: true
