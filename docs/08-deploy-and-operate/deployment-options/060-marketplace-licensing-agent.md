...
nav_order: 60
permalink: /operate/deployment-options/marketplace-licensing-agent
content_type: how-to
redirect_from: ["/deployment/marketplace-licensing-agent"]
source_path: docs/020-deployment/006-licensing-agent-install.md
...
1. If required - [Request Azure Policy Exemption](/operate/deployment-options/azure-policy-exemption).
