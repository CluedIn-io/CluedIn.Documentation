...
nav_order: 80
permalink: /operate/deployment-options/delete-cluedin-instance
content_type: how-to
redirect_from: ["/deployment/delete-cluedin-instance"]
source_path: docs/020-deployment/005-delete-cluedin-instance.md
---
...
This article outlines how to delete your CluedIn instance if you no longer want to use it. Note that all data that you have in CluedIn will be permanently deleted. Therefore, consider making [backups](/archive/historical-operations/backup-and-restore-draft) if needed.

## Delete CluedIn PaaS

If you no longer want to use CluedIn PaaS or if the installation of CluedIn PaaS failed, you can delete the instance. Deleting CluedIn PaaS instance will reset your CluedIn license. It means that you can [install](/operate/azure-marketplace/step-3) CluedIn again using the same license key.
