...
nav_order: 20
permalink: /operate/monitoring/processing-pipeline
content_type: concept
redirect_from: ["/engine-room/processing-pipeline"]
source_path: docs/120-engine-room/010-cluedIn-performance-metrics.md
