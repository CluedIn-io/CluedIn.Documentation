...
nav_order: 180
permalink: /operate/upgrade/2026-02-00
content_type: reference
redirect_from: ["/paas-operations/upgrade/2026-02-00"]
source_path: docs/190-paas-operations/upgrade/216-upgrade-20260200.md
tags: ["upgrade", "software", "2026.02.00", "2.8.0", "4.8.0"]
headerIcon: "paas"
---
...
This document covers the upgrade process from 2026.01.00 to 2026.02.00.

{:.important}
We do not support upgrading directly to this version from prior to 2026.01.00.

## Prerequisites
- Access to the Helm chart version `2.8.0`. You may need to run `helm repo update` to grab the latest version.
        ...
        cluedin:
          components:
            ...
            - name: "CluedIn.Connector.Dataverse"
              version: "4.8.0"
            - name: "CluedIn.Connector.Dataverse.V2" 
              version: "4.7.3"
            - name: "CluedIn.Connector.Http"
              version: "4.5.0"
            - name: "CluedIn.EventHub"
              version: "4.7.0"
            - name: "CluedIn.Connector.AmazonS3"
              version: "4.8.0"
            ...
            - name: "CluedIn.Provider.ExternalSearch.Providers.ArtificialIntelligence"
              version: "4.6.1"
            - name: "CluedIn.Provider.ExternalSearch.Providers.BvD"
              version: "4.7.1"
  ...
  1. Apply data upgrade by running following command:
      ...
      metadata:
        ...
        labels:
          ...
          helm.sh/chart: application-2.8.0
          release: cluedin-platform
        name: data-upgrade-480
        namespace: cluedin
      spec:
        toVersion: Version480
      EOF
      ```
