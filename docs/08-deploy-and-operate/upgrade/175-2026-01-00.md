...
nav_order: 175
permalink: /operate/upgrade/2026-01-00
content_type: reference
redirect_from: ["/paas-operations/upgrade/2026-01-00"]
source_path: docs/190-paas-operations/upgrade/215-upgrade-20260100.md
tags: ["upgrade", "software", "2026.01.00", "2.7.0", "4.7.0"]
headerIcon: "paas"
---
...
{:.important}
We do not support upgrading directly to this version from prior to 2025.09.00.
For latest support release visit [2026.01.00-support](/operate/upgrade/2026-01-00-support)
  ...
  1. Apply data upgrade by running following command:
      ...
      metadata:
        ...
        labels:
          ...
          helm.sh/chart: application-2.7.0
          release: cluedin-platform
        name: data-upgrade-470
        namespace: cluedin
      spec:
        toVersion: Version470
      EOF
      ```
