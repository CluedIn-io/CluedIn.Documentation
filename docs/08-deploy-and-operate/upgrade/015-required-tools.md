...
nav_order: 15
permalink: /operate/upgrade/required-tools
content_type: reference
redirect_from: ["/paas-operations/upgrade/guide/required-tools"]
source_path: docs/190-paas-operations/upgrade/upgrade-guide/060-required-tools.md
...
Before starting [CluedIn upgrade](/operate/upgrade/guide), make sure you have the necessary tools installed and ready:
...
Once you [connect Lens (or Freelens) your CluedIn cluster](/operate/upgrade/prepare-for-the-upgrade#connect-lens-or-freelens-to-your-cluedin-cluster), it allows you to:
