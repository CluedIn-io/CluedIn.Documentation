...
nav_order: 80
has_children: true
permalink: /operate/backup-and-restore
content_type: landing
summary: Protecting an installation and getting it back.
list_children: false
redirect_from: ["/deployment/infra-how-tos/ama-backup"]
source_path: docs/190-paas-operations/002-backup-and-restore.md
...
- [Disaster recovery runbook](/operate/backup-and-restore/disaster-recovery-runbook) – responsible for orchestrating the backup > copy > restore process.

- [Backup runbook](/operate/backup-and-restore/backup-runbook) – responsible for capturing snapshots of all persistent disks used by CluedIn.

- [Copy snapshots runbook](/operate/backup-and-restore/copy-snapshots-runbook) – responsible for copying snapshots from one Azure location to another.

- [Restore runbook](/operate/backup-and-restore/restore-runbook) – responsible for removing all persistent disks and restoring them from snapshots.
