...
nav_order: 60
permalink: /operate/backup-and-restore/disaster-recovery-runbook-failover-database
content_type: how-to
redirect_from: ["/paas-operations/automation/disaster-recovery-runbook-failover-database"]
source_path: docs/190-paas-operations/backup-and-restore/011-disaster-recovery-runbook-failover-database.md
headerIcon: "paas"
---
...
- Pre 2025.09.00 use [Disaster recovery runbook - legacy](/archive/historical-operations/disaster-recovery-runbook-pre-2025-09)
