...
nav_order: 40
permalink: /operate/backup-and-restore/restore-runbook
content_type: how-to
redirect_from: ["/paas-operations/automation/restore-runbook"]
source_path: docs/190-paas-operations/backup-and-restore/040-restore-runbook.md
headerIcon: "paas"
---
