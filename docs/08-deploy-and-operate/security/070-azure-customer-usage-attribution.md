...
nav_order: 70
permalink: /operate/security/azure-customer-usage-attribution
content_type: reference
redirect_from: ["/kb/azure-customer-usage-attribution"]
source_path: docs/200-kb/kb0001-pid.md
...
Assuming that you are in the same PowerShell session since you [created the resource group](/operate/security/azure-customer-usage-attribution#create-a-resource-group), run the following:
