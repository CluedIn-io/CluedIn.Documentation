...
nav_order: 10
permalink: /operate/azure-marketplace/step-1
content_type: concept
redirect_from: ["/deployment/azure-marketplace/step-1"]
source_path: docs/020-deployment/ama/020-ama-first-step.md
...
- If you have signed a committed deal:
  ...
  - Link to our [Pre-installation checklist](/operate/azure-marketplace/step-2).
