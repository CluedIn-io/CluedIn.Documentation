...
nav_order: 30
permalink: /operate/azure-marketplace/step-3
content_type: how-to
redirect_from: ["/deployment/azure-marketplace/step-3"]
source_path: docs/020-deployment/ama/040-ama-third-step.md
...
- Make sure that you have completed all of the actions described in [Pre-installation checklist](/operate/azure-marketplace/step-2).
...
1. In **Software plan**, select the plan of your choice:
    ...
    - **CluedIn MDM PaaS - Pay As You Go** – select this option if you want to use CluedIn on a pay-as-you-go basis. For more information, see [Pricing](/operate/deployment-options/pricing).
...
Customize CluedIn to meet your organization's needs as described in our [Post-installation guide](/operate/azure-marketplace/step-4).
