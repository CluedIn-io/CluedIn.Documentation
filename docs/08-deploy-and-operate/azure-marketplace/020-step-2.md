...
nav_order: 20
permalink: /operate/azure-marketplace/step-2
content_type: reference
redirect_from: ["/deployment/azure-marketplace/step-2"]
source_path: docs/020-deployment/ama/030-ama-second-step.md
...
For the list of firewall rules that should be added to your Azure Firewall, see [Configure firewall](/operate/configuration/configure-firewall).
...
More information regarding networking can be found in<a href="/operate/configuration/advanced-network"> Advanced network configuration</a>.
...
Start the CluedIn installation process as described in our <a href="/operate/azure-marketplace/step-3">Installation guide</a>.
