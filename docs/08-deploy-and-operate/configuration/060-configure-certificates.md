...
nav_order: 60
permalink: /operate/configuration/configure-certificates
content_type: how-to
redirect_from: ["/deployment/infra-how-tos/configure-certificates"]
source_path: docs/190-paas-operations/configuration/070-configure-certificates.md
