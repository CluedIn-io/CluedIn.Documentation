...
nav_order: 120
permalink: /operate/configuration/modify-response-headers
content_type: how-to
redirect_from: ["/paas-operations/config/modify-response-headers"]
source_path: docs/190-paas-operations/configuration/115-modify-response-headers.md
