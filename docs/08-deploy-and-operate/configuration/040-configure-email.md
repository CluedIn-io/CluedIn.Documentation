...
nav_order: 40
permalink: /operate/configuration/configure-email
content_type: how-to
redirect_from: ["/deployment/infra-how-tos/configure-email"]
source_path: docs/190-paas-operations/configuration/040-configure-email.md
