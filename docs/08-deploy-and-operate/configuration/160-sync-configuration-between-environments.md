...
nav_order: 160
permalink: /operate/configuration/sync-configuration-between-environments
content_type: how-to
redirect_from: ["/kb/config-migrate"]
source_path: docs/190-paas-operations/007-configuration-migration.md
