...
nav_order: 110
permalink: /operate/configuration/sql
content_type: how-to
redirect_from: ["/deployment/kubernetes/sql"]
source_path: docs/190-paas-operations/configuration/114-configure-sqlserver.md
