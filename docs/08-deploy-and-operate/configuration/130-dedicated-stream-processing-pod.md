...
nav_order: 130
permalink: /operate/configuration/dedicated-stream-processing-pod
content_type: how-to
redirect_from: ["/paas-operations/config/dedicated-stream-processing-pod"]
source_path: docs/190-paas-operations/configuration/116-dedicated-stream-processing-pod.md
