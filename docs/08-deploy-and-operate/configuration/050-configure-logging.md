...
nav_order: 50
permalink: /operate/configuration/configure-logging
content_type: how-to
redirect_from: ["/deployment/infra-how-tos/configure-logging"]
source_path: docs/190-paas-operations/configuration/050-configure-logging.md
