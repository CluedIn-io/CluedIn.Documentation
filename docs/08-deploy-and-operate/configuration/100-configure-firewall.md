...
nav_order: 100
permalink: /operate/configuration/configure-firewall
content_type: how-to
redirect_from: ["/deployment/infra-how-tos/configure-firewall"]
source_path: docs/190-paas-operations/configuration/100-configure-firewall.md
...
Additionally, if you want to use Power Automate integration for [workflows](/govern/workflows) in CluedIn and/or [Power Apps integration](/solutions/power-apps), you need to add specific URLs to your Azure Firewall as described [here](#power-apps-and-power-automate)
...
If you want to use Power Automate integration for [workflows](/govern/workflows) in CluedIn and/or [Power Apps integration](/solutions/power-apps), you need to add the following rules to your Azure Firewall:
...
- `https://<environment-id>.api.powerplatform.com` – for example, `https://b2b5d7282e2ae37c96e263cf126c08.4e.environment.api.powerplatform.com`
