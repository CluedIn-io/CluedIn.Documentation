...
nav_order: 140
permalink: /operate/configuration/private-endpoint
content_type: how-to
redirect_from: ["/paas-operations/private-endpoint"]
source_path: docs/190-paas-operations/170-private-endpoint.md
...
- If your service requires private connectivity for **more than eight private endpoints**, you have the following option:
