...
nav_order: 30
permalink: /operate/configuration/advanced-network
content_type: how-to
redirect_from: ["/deployment/infra-how-tos/advanced-network"]
source_path: docs/190-paas-operations/configuration/030-advanced-network.md
...
Advanced network configuration requires that you have read and configured your firewall as per the firewall policy. For more information, see [Configure firewall](/operate/configuration/configure-firewall).
...
- [Configure DNS](/operate/configuration/configure-dns)
- [Configure certificates](/operate/configuration/configure-certificates)
