...
nav_order: 30
permalink: /operate/local/step-3
content_type: how-to
redirect_from: ["/deployment/local/step-3"]
source_path: docs/020-deployment/local/030-extension-package.md
...
- Learn more about CluedIn functionality in our [Getting started guide](/get-started/quickstart).

- Learn how to [install CluedIn from the Azure Marketplace](/operate/deployment-options/azure-marketplace).