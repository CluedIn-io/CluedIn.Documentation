...
nav_order: 20
permalink: /operate/local/step-2
content_type: how-to
redirect_from: ["/deployment/local/step-2"]
source_path: docs/020-deployment/local/020-local-install-guide.md
...
You can find the ACR to which you have been granted access in the <a href="/operate/local/step-1#get-access-to-CluedIn-container-registry">email from CluedIn</a>.
...
Add more features to CluedIn with the help of extension packages. Learn how to do that in [Extension packages](/operate/local/step-3).
