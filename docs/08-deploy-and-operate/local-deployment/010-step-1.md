...
nav_order: 10
permalink: /operate/local/step-1
content_type: reference
redirect_from: ["/deployment/local/step-1"]
source_path: docs/020-deployment/local/010-requirements.md
...
Start the local installation of CluedIn as described in our [Local installation guide](/operate/local/step-2).