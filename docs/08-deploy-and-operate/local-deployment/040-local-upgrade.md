...
layout: cluedin
title: Local upgrade
parent: Local deployment
grand_parent: Deploy & operate
nav_order: 40
permalink: /operate/local/local-upgrade
content_type: how-to
redirect_from: ["/deployment/local/local-upgrade"]
source_path: docs/020-deployment/local/040-local-upgrade.md
