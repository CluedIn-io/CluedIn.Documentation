...
nav_order: 10
permalink: /operate/operations/support-scope
content_type: reference
redirect_from: ["/paas-operations/support-scope"]
source_path: docs/190-paas-operations/006-support-scope.md
