...
nav_order: 20
permalink: /operate/operations/env-management-playbook
content_type: how-to
redirect_from: ["/kb/env-management-playbook"]
source_path: docs/190-paas-operations/009-env-management.md
...
To learn more about roles, check out our dedicated [article](/administer/users-and-roles/roles). The reason we mention these roles is because they should have different privileges in each environment.
