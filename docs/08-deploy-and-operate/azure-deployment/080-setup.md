...
nav_order: 80
permalink: /operate/azure/setup
content_type: how-to
redirect_from: ["/deployment/azure/setup"]
source_path: docs/020-deployment/azure/080-cluedin-setup.md
...
- Go to [Step-by-Step Setup](/operate/azure/walkthrough)

### Option 2: PowerShell Setup

- Go to [PowerShell Setup](/operate/azure/powershell)