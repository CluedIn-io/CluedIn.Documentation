...
nav_order: 100
permalink: /operate/azure/powershell
content_type: how-to
redirect_from: ["/deployment/azure/setup/powershell"]
source_path: docs/020-deployment/azure/setup/020-full-azure-cli-install.md
...
**Note**: Before proceeding with the installation, you must ensure that all [pre-requisites](/operate/azure/setup#pre-requisites--preparation) are met.
...
- [Restricting access to CluedIn Clean via Basic Authentication](/operate/security/basic-auth-cluedin-clean)
- [Install a crawler/custom component](/ingest/connectors/install-integrations)

Optionally, you can also adjust other settings to cater for more complex scenarios:
- [Persistence/Using Managed Disks](/operate/configuration/persistence)
- [Azure SQL Server](/operate/configuration/sql)
