...
parent: Get started
nav_order: 70
permalink: /get-started/getting-access
content_type: how-to
redirect_from: ["/getting-access"]
source_path: docs/020-getting-access.md
---
...
- **Sign up for CluedIn Saas** - , see [CluedIn SaaS](/operate/deployment-options/cluedin-saas).

- **Installation of CluedIn Private SaaS** – sign in to CluedIn using the email address and password that you specified when configuring your CluedIn account. For more information, see [CluedIn Private SaaS installation guide](/operate/deployment-options/saas).

- **Installation of CluedIn PaaS** – sign in to CluedIn using the email address and password that you specified on the **Instance Setup** tab of CluedIn installation. For more information, see [CluedIn PaaS installation guide](/operate/azure-marketplace/step-3#complete-the-instance-setup-tab).

- **Local installation of CluedIn** – sign in to CluedIn using the email address and password you created on the last step of local CluedIn installation. For more information, see [Local installation guide](/operate/local/step-2).
