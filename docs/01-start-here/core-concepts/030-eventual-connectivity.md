...
nav_order: 30
permalink: /get-started/core-concepts/eventual-connectivity
content_type: concept
redirect_from: ["/key-terms-and-features/eventual-connectivity"]
source_path: docs/110-key-terms-and-features/080-eventual-connectivity.md
...
- Identifiers – universally unique identifiers of a record. Read more about identifiers [here](/model/identifiers).

- Edges – a way to instruct CluedIn that there is a reference from one object to another. Edges are the key behind the eventual connectivity pattern. Read more about edge [here](/model/relationships/edges).
...
- Vocabularies – a way to map properties from the source system to a common vocabulary that CluedIn understands. The vocabularies are key to bridge data across systems. For more information, see a video about vocabulary key mapping [here](/model/data-catalog/modeling-approaches).
