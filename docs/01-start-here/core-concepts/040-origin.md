...
nav_order: 40
permalink: /get-started/core-concepts/origin
content_type: concept
redirect_from: ["/key-terms-and-features/origin"]
source_path: docs/110-key-terms-and-features/120-origin.md
...
As mentioned in our [Identifiers](/model/identifiers) reference article, the origin is used in the primary identifier and the identifiers.
