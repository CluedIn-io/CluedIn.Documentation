...
nav_order: 70
permalink: /get-started/core-concepts/billable-records
content_type: concept
redirect_from: ["/key-terms-and-features/billable-records"]
source_path: docs/110-key-terms-and-features/060-billable-records.md
---

A billable record is a unique data part that forms a golden record. In this case, an ingested record is considered a data part. For more information about records, data parts, and golden records, see [Data life cycle](/get-started/core-concepts/data-life-cycle).
...
Each record that you ingest and process from your source counts as a billable record. If 2 records come from the same source and share the same identifier ([primary identifier](/model/identifiers) and [origin](/get-started/core-concepts/origin)) then they are considered exact duplicates and are merged into one golden record. This is 1 billable record.
