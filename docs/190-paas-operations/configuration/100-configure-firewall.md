...
| `AKS Control Plane` | 443 | (For public clusters only). FQDN can be found under the AKS resource next to the property `API server address` (example: `aks-cluedin.hcp.westeurope.azmk8s.io`) |
