...
nav_order: 90
permalink: /learning-paths/data-architect/export-targets-and-destination-setup
content_type: tutorial
redirect_from: ["/learning-paths/data-architect-course/export-targets-and-destination-setup"]
source_path: docs/120-learning-paths/data-architect-course/090-export-targets-and-destination-setup.md
---
...
Continue to [Configure Streams and downstream contracts](/learning-paths/data-architect/streams-and-downstream-contracts).
