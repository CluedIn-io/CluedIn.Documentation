...
nav_order: 20
permalink: /learning-paths/data-architect/platform-model-business-domains-vocabularies-and-golden-records
content_type: tutorial
redirect_from: ["/learning-paths/data-architect-course/platform-model-business-domains-vocabularies-and-golden-records"]
source_path: docs/120-learning-paths/data-architect-course/020-platform-model-business-domains-vocabularies-and-golden-records.md
---
...
- [Business domains](/model/business-domains/manage-business-domains)
...
Continue to [Build ingestion pipelines and support incremental or CDC ingestion](/learning-paths/data-architect/ingestion-design-and-mapping-strategy).
