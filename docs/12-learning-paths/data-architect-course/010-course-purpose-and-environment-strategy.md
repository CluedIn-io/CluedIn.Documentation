...
nav_order: 10
permalink: /learning-paths/data-architect/course-purpose-and-environment-strategy
content_type: tutorial
redirect_from: ["/learning-paths/data-architect-course/course-purpose-and-environment-strategy"]
source_path: docs/120-learning-paths/data-architect-course/010-course-purpose-and-environment-strategy.md
---
...
- [Roles](/administer/users-and-roles/roles)
- [Feature access](/administer/users-and-roles/feature-access)
...
Continue to [Business domains, vocabularies, golden records, and the Global Data Model](/learning-paths/data-architect/platform-model-business-domains-vocabularies-and-golden-records).
