...
nav_order: 10
permalink: /administer/access-control/create-access-control-policy
content_type: how-to
redirect_from: ["/management/access-control/create-access-control-policy"]
source_path: docs/080-management/access-control/010-create-access-control-policy.md
---
...
1. In the **Rules** section, select **Add Policy Rule**, and then define the policy rule:
    ...
    1. In **Action**, select the type of access to golden record properties: view, mask, or add/edit. Learn more in [Access control reference](/administer/access-control/access-control-reference).
