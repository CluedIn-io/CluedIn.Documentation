...
nav_order: 30
permalink: /administer/ui-configuration/side-navigation-menu
content_type: how-to
redirect_from: ["/administration/side-navigation-menu"]
source_path: docs/030-administration/user-interface/020-side-navigation-menu.md
---
...
- You must have access to manage the [feature flags](/administer/feature-flags). This access requires [administrator permissions](/administer/users-and-roles/claims#admin).
