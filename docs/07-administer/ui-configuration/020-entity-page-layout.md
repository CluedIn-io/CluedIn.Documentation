...
nav_order: 20
permalink: /administer/ui-configuration/entity-page-layout
content_type: how-to
redirect_from: ["/administration/entity-page-layout"]
source_path: docs/030-administration/user-interface/010-entity-page-layout.md
---
...
When you create a new business domain while creating mapping, the default layout is assigned to such business domain. You change the layout later by [editing](/model/business-domains/manage-business-domains#manage-an-entity-type) the business domain.
