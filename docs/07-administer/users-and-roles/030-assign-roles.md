...
nav_order: 30
permalink: /administer/users-and-roles/assign-roles
content_type: how-to
redirect_from: ["/administration/roles/assign-roles"]
source_path: docs/030-administration/030-assign-roles.md
...
After you [add a user to CluedIn](/administer/users-and-roles/user-management), you can give the user access to more features within the platform by adding other roles to the user.
