...
nav_order: 80
permalink: /administer/users-and-roles/data-access
content_type: how-to
redirect_from: ["/administration/user-access/data-access"]
source_path: docs/030-administration/user-access/010-data-access.md
---
...
{:.important}
The operations that users can perform with data depend on the roles assigned to the users. For more information, see [Roles](/administer/users-and-roles/roles).
...
Learn how to create an access control policy in the dedicated [article](/administer/access-control).
