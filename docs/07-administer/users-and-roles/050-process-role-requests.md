...
nav_order: 50
permalink: /administer/users-and-roles/process-role-requests
content_type: how-to
redirect_from: ["/administration/roles/process-role-requests"]
source_path: docs/030-administration/050-process-role-requests.md
