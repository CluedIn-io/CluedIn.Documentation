...
nav_order: 10
permalink: /govern/ai-agents/prerequisites-to-using-ai-agents
content_type: reference
redirect_from: ["/management/ai-agents/prerequisites-to-using-ai-agents"]
source_path: docs/080-management/ai-agents/010-prerequisites-to-using-ai-agents.md
...
The **AI Agents** feature is controlled by [feature flags](/administer/feature-flags) and is not enabled by default. You must enable the feature to use it.
...
1. Select **Create**.
    ...
    The model endpoint is created, and you can proceed to [create AI agents and jobs](/govern/ai-agents/create-configure-and-run-an-ai-agent).
...
1. Configure the following settings:
    ...
    - **Auto-approve AI suggestions** – when enabled, all suggestions returned by an AI agent will be automatically approved. The users will not need to [manually review and approve/reject the suggestions](/govern/ai-agents/review-the-results-returned-by-an-ai-agent).