...
nav_order: 60
permalink: /govern/ai-agents/ai-agents-faqs
content_type: reference
redirect_from: ["/management/ai-agents/ai-agents-faqs"]
source_path: docs/080-management/ai-agents/060-ai-agents-faqs.md
...
{:.important}
The information in this article applies to the following [CluedIn deployment models](/get-started/get-cluedin): PaaS, private SaaS.

This article addresses commonly asked questions about [AI agents](/govern/ai-agents) in CluedIn, including their setup, operation, and security controls.
...
- All data mounted to an AI agent respects [CluedIn’s access control rules](/administer/access-control) – access can be restricted or even masked at the cell level.
- For configuration instructions, see [Create, configure, and run an AI agent](/govern/ai-agents/create-configure-and-run-an-ai-agent).
...
- Access to one or more datasets, governed by [CluedIn’s access control rules](/administer/access-control).
...
You can monitor the following:
 - What data is sent and to which destinations.
    ...
    CluedIn audits all communications between the AI agent and its LLM, including data payloads. You can [review](/govern/ai-agents/review-the-results-returned-by-an-ai-agent) this information on the **Results** tab of the AI agent.
