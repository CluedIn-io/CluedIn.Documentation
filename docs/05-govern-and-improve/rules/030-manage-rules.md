...
nav_order: 30
permalink: /govern/rules/manage-rules
content_type: how-to
redirect_from: ["/management/rules/manage-rules"]
source_path: docs/080-management/rules/030-manage-rules.md
...
1. Select **Duplicate**.
    ...
    The new rule is created. By default, it is inactive. Now, you can modify the rule configuration as needed. When you reach the desired configuration, save your changes, [activate](/govern/rules/manage-rules#activate-and-deactivate-a-rule) the rule, and then [reprocess](/govern/rules/create-rule#apply-a-rule-to-all-records) the affected records.