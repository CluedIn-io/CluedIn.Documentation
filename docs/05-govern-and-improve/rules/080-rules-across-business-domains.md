...
nav_order: 80
permalink: /govern/rules/rules-across-business-domains
content_type: how-to
redirect_from: ["/kb/how-to-write-rules-cross-domain"]
source_path: docs/200-kb/how-to/090-rules-that-work-across-business-domains.md
---
