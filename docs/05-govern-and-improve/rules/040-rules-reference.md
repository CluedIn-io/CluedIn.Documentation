...
nav_order: 40
permalink: /govern/rules/rules-reference
content_type: reference
redirect_from: ["/management/rules/rules-reference"]
source_path: docs/080-management/rules/040-rules-reference.md
...
| Mask Value | Applies a mask to the value. You can use this action to hide sensitive data. Note that this action will be deprecated in future releases; therefore, use the [mask action](/administer/access-control/access-control-reference#) in access control policy rules instead. |
