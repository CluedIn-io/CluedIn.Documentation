...
nav_order: 30
permalink: /govern/tags/how-to-tag-records-with-data-quality-issues
content_type: how-to
redirect_from: ["/kb/how-to-tag-records-with-data-quality-issues"]
source_path: docs/200-kb/how-to/020-tag-records-with-data-quality-issues.md
---
...
1. When the records with data quality issues are tagged, you can then [create](/govern/cleaning/create-clean-project) a clean project to fix such issues. To do it, in the upper-right corner of the search results page, open the three-dot menu, and select **Clean**.
