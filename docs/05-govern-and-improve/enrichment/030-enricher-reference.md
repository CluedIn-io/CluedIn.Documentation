...
nav_order: 30
permalink: /govern/enrichment/enricher-reference
content_type: reference
redirect_from: ["/preparation/enricher/enricher-reference"]
source_path: docs/050-preparation/enricher/030-enricher-reference.md
---
...
{:.important}
If you need a custom enricher, use the [REST API enricher](/govern/enrichment/rest-api) or contact us, and we will build one for you.

## Azure OpenAI

The [Azure OpenAI](/govern/enrichment/artificial-intelligence) enricher allows you to enhance data quality by providing more complete, current, and detailed information for your golden records. It supports the following endpoints:
...
The [Brreg](/govern/enrichment/brreg) enricher retrieves a wide range of information about Norwegian and foreign businesses operating in Norway. It supports the following endpoints:
...
The [Clearbit](/govern/enrichment/clearbit) enricher retrieves company logo and domain information. It supports the following endpoint:
...
The [Companies House](/govern/enrichment/companies-house) enricher retrieves information about UK companies. This enricher uses the company name to return public information including registered office address, filing history, and so on.
...
The [CVR](/govern/enrichment/cvr) enricher retrieves a wide range of information about companies registered in Denmark. It supports the following endpoint:
...
The [DuckDuckGo](/govern/enrichment/duckduckgo) enricher retrieves general information about organizations from the DuckDuckGo search engine. It supports the following endpoint:
...
The [Gleif](/govern/enrichment/gleif) enricher retrieves information about organizations using the Legal Entity Identifier (LEI). It supports the following endpoint:
...
The [Google Maps](/govern/enrichment/google-maps) enricher cleans, standardizes, and enriches international postal addresses with geocoding information. This enricher returns correct information about company address.
...
The [Knowledge Graph](/govern/enrichment/knowledge-graph) enricher retrieves descriptions of organizations using the Google Knowledge Graph API. It supports the following endpoint:
...
The [Libpostal](/govern/enrichment/libpostal) enricher parses and normalizes street addresses using statistical NLP and open data. This enricher returns international street address.
...
The [Open Corporates](/govern/enrichment/open-corporates) enricher retrieves information on all companies worldwide. This enricher returns VAT/TAX number.
...
The [PermId](/govern/enrichment/perm-id) enricher retrieves information about organizations from the PermID database. It supports the following endpoints:
...
The [Vatlayer](/govern/enrichment/vatlayer) enricher validates and cleans EU VAT numbers. It supports the following endpoint:
...
The [Web](/govern/enrichment/web) enricher retrieves information about organizations through their websites. The Web enricher supports any website provided in the **Website Vocab Key** field of the enricher configuration.
