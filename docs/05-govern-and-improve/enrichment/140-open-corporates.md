...
nav_order: 140
permalink: /govern/enrichment/open-corporates
content_type: reference
redirect_from: ["/preparation/enricher/open-corporates"]
source_path: docs/050-preparation/enricher/140-open-corporates.md
---
