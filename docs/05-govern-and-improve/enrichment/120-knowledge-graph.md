...
nav_order: 120
permalink: /govern/enrichment/knowledge-graph
content_type: reference
redirect_from: ["/preparation/enricher/knowledge-graph"]
source_path: docs/050-preparation/enricher/120-knowledge-graph.md
---
