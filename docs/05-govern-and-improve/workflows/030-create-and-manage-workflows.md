...
nav_order: 30
permalink: /govern/workflows/create-and-manage-workflows
content_type: how-to
redirect_from: ["/workflow/create-and-manage-workflows"]
source_path: docs/130-workflow.md/030-create-and-manage-workflows.md
---
...
{:.important}
To use the **Workflow** module in CluedIn, you need to configure [Power Automate integration](/solutions/power-automate).
...
_* The approval requests for this action are sent only if the [business domain](/model/business-domains/manage-business-domains) of the records has the **Batch approval workflow** option enabled._
