...
nav_order: 40
permalink: /govern/workflows/manage-approval-requests
content_type: how-to
redirect_from: ["/workflow/manage-approval-requests"]
source_path: docs/130-workflow.md/040-manage-approval-requests.md
---
