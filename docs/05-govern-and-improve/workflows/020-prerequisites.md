...
nav_order: 20
permalink: /govern/workflows/prerequisites
content_type: reference
redirect_from: ["/workflow/prerequisites"]
source_path: docs/130-workflow.md/020-prerequisites.md
published: false
---
...
{:.important}
Before configuring workflows, ensure that you have added the specific URLs to your Azure Firewall as described [here](/operate/configuration/configure-firewall#power-automate).
...
1. Select **Register CluedIn Connector**.
    ...
    Now, you can [create workflows](/govern/workflows/create-and-manage-workflows) to automate certain approval processes. 
