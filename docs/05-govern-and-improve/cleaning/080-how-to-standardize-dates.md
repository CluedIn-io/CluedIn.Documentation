...
nav_order: 80
permalink: /govern/cleaning/how-to-standardize-dates
content_type: how-to
redirect_from: ["/kb/how-to-standardize-dates"]
source_path: docs/200-kb/how-to/030-standardize-dates.md
---
...
1. To convert dates into ISO 8601 format (YYYY-MM-DDT00:00:00+00:00), [create](/govern/rules/create-rule) a data part rule and add an action to normalize dates. In the action, specify the culture of the input dates to help CluedIn interpret the values.
