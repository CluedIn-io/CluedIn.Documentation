...
nav_order: 20
permalink: /govern/cleaning/manage-clean-project
content_type: how-to
redirect_from: ["/preparation/clean/manage-clean-project"]
source_path: docs/050-preparation/clean/020-manage-clean-project.md
...
- Transform the contents of the cells in a column:
    ...
    - In the column heading, expand the menu, and then select **Edit cells** > **Common transforms**. Then, choose the transformation option (for example, collapse consecutive whitespace or transform the text to title case). For more information, see [Clean application reference](/govern/cleaning/clean-application-reference).
...
1. Select **Duplicate**.
    ...
    The new clean project is created, and it has the **New** [status](/govern/cleaning/clean-reference#clean-project-statuses). Now, you can modify the clean project configuration if needed. When you reach the desired configuration, save your changes, [generate results](/govern/cleaning/manage-clean-project#generate-results), and then start the [cleaning activities](/govern/cleaning/manage-clean-project#clean-data).