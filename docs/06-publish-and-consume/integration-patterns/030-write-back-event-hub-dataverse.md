...
nav_order: 30
permalink: /publish/integration-patterns/write-back-event-hub-dataverse
content_type: how-to
redirect_from: ["/playbooks/writing-back-to-target-datasources"]
source_path: docs/210-playbooks/120-writing-back-to-datasource.md
---
