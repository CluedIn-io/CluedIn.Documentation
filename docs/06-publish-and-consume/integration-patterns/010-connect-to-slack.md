...
nav_order: 10
permalink: /publish/integration-patterns/connect-to-slack
content_type: how-to
redirect_from: ["/kb/connect-to-slack"]
source_path: docs/200-kb/how-to/100-connect-cluedin-to-slack.md
---
