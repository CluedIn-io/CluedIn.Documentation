...
nav_order: 60
permalink: /publish/streams/tutorial-stream-data
content_type: tutorial
redirect_from: ["/getting-started/data-streaming"]
source_path: docs/010-getting-started/050-data-streaming.md
...
Next, learn how to create rules for automating data transformation and capturing data quality issues in the [Create rules guide](/govern/rules/tutorial-create-rules).