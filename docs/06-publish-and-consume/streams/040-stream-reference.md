...
nav_order: 40
permalink: /publish/streams/stream-reference
content_type: reference
redirect_from: ["/consume/streams/stream-reference"]
source_path: docs/150-consume/streams/030-stream-reference.md
...
| Not exporting | The export target is not receiving records. To fix this, check the [export target](/publish/export-targets) configuration. |
