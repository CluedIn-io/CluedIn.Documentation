...
nav_order: 80
permalink: /publish/export-targets/http-connector
content_type: reference
redirect_from: ["/consume/export-targets/http-connector"]
source_path: docs/150-consume/export-targets/070-http-connector.md
