...
nav_order: 90
permalink: /publish/export-targets/onelake-connector
content_type: reference
redirect_from: ["/consume/export-targets/onelake-connector"]
source_path: docs/150-consume/export-targets/080-onelake-connector.md
...
- Make sure you have a [service principal](/publish/export-targets/create-service-principal) to authenticate and access OneLake.
