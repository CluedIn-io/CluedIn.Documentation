...
nav_order: 110
permalink: /publish/export-targets/sql-server-connector
content_type: reference
redirect_from: ["/consume/export-targets/sql-server-connector"]
source_path: docs/150-consume/export-targets/090-sql-server-connector.md
