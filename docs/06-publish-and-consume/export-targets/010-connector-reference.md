...
nav_order: 10
permalink: /publish/export-targets/connector-reference
content_type: reference
redirect_from: ["/consume/export-targets/connector-reference"]
source_path: docs/150-consume/export-targets/010-connector-reference.md
---
...
The [Azure Data Lake](/publish/export-targets/adl-connector) connector allows you to publish data to Azure Data Lake Storage Gen2.
...
The [Azure Dedicated SQL Pool](/publish/export-targets/azure-dedicated-sql-pool-connector) connector allows you to publish data to Microsoft’s Dedicated SQL Pool, which is a part of Azure Synapse Analytics platform.
...
The [Azure Event Hub](/publish/export-targets/azure-event-hub-connector) connector allows you to publish data to Azure Event Hubs.
...
The [Azure Service Bus](/publish/export-targets/azure-service-bus-connector) connector allows you to publish data to Azure Service Bus.
...
The [Dataverse](/publish/export-targets/dataverse-connector) connector allows you to publish data to Microsoft Dataverse.
...
The [HTTP](/publish/export-targets/http-connector) connector allows you to publish data to your own API endpoint.
...
The [OneLake](/publish/export-targets/onelake-connector) connector allows you to publish data to Microsoft’s OneLake.
...
The [SQL Server](/publish/export-targets/sql-server-connector) connector allows you to publish data to a Microsoft SQL Server database.
