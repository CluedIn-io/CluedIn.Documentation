...
nav_order: 70
permalink: /publish/export-targets/dataverse-connector
content_type: reference
redirect_from: ["/consume/export-targets/dataverse-connector"]
source_path: docs/150-consume/export-targets/060-dataverse-connector.md
...
> **Note:**
> This is the legacy Dataverse connector (V1). It is only available for CluedIn installations that have been upgraded and were previously using the Dataverse connector. This connector has been superseded by the new [Dataverse connector](/publish/export-targets/dataverse-connector-v2) (V2), which is not backwards compatible. There is no automated migration path from V1 to V2, as customers may have built apps on top of the V1 tables. For new installations, use the [Dataverse connector](/publish/export-targets/dataverse-connector-v2) (V2).
>
...
- Create a service principal (app registration) by following the instructions in [this article](/publish/export-targets/create-service-principal). This step is needed to get **Client ID**, **Tenant ID**, and **Client Secret** for connector configuration.
