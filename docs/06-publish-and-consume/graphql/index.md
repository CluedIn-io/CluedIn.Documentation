...
nav_order: 40
has_children: true
permalink: /publish/graphql
content_type: landing
summary: GraphQL is the query interface for reading golden records on demand, as opposed to streams, which push them continuously.
redirect_from: ["/consume/graphql"]
source_path: docs/150-consume/010-graphql.md
