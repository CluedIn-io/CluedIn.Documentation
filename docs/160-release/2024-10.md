...
After performing a search, you can now export your results in one of the following formats: JSON, CSV, XLSX, or Parquet. For more information, see [Exporting golden records](/Documentation/Key-terms-and-features/Search#export-search-results).
