...
A centralized view of system activity, allowing users to track changes to rules, deduplication configurations, and data set removals from a single page. This makes it easier to understand what has changed over time and to support auditing and troubleshooting needs.
