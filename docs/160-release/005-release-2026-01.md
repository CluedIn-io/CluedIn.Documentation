...
**Presentation:** <a href="../../../assets/other/release/What's new in CluedIn 2026.01.pptx" download>Download PPT</a>
...
To reduce clutter and confusion, menu items are now shown only to users who have access to the corresponding functionality. This ensures the interface stays focused on relevant actions, improves clarity around permissions, and helps users work more confidently within their role.

 ![MenuVisibility.png](../../assets/images/release/Release 2026.01/MenuVisibility.png)

### Performance Improvement - Data Set Loading

Data stewards frequently work with large and complex data sets, where slow loading can disrupt workflows. In this release, we’ve improved the performance of the Data Set loading experience, resulting in faster page loads and smoother interactions when accessing and reviewing data.

## Global Audit Logs

To support stronger governance and transparency, we’ve introduced Global Audit Logs. This new area provides a centralized view of system activity, allowing users to track changes to rules, deduplication configurations, and data set removals from a single page. This makes it easier to understand what has changed over time and to support auditing and troubleshooting needs.
...
#### New Property Page
Previously, editing properties often required moving between multiple screens, which slowed down corrections and increased the chance of errors. The new Property Page brings all editable attributes into a single view, enabling faster updates, greater consistency, and a more focused editing experience.
    
![PropertyPage.png](../../assets/images/release/Release 2026.01/PropertyPage.png)

#### New Relation Page

Understanding relationships between records is essential for data quality and lineage. The redesigned Relation Page makes it easier to explore and manage these connections by allowing users to add and edit relations directly within the Relations tab. Advanced filtering aligned with the Global Search experience helps users quickly find relevant relationships, even in complex data sets.
...
Based on user feedback, we’ve redesigned the Search page to improve usability and efficiency for data stewards. Filters are now always visible in a left-hand panel, giving quick access to filtering and key record information while working with Golden Records. Advanced filters have been reviewed and simplified, and your recent searches are now saved in the search history, allowing you to easily return to previous queries without having to recreate them.
In addition, vocabulary key values can now be edited directly from the Search page. This inline editing supports text, boolean, and reference data values, making it faster and easier to correct or refine Golden Records without leaving the search context.
