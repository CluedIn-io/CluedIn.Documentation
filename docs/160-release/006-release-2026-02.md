...
#### Auto incrmeneting values
You can add an action to add an auto incrementing number to each record. We do not guarentee that the numbers will be consecutive but they will be unique at the time of generation. You can also optionaly set a min and max value to this auto incremeneting value.
