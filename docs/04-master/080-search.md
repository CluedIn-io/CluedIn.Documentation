...
parent: Master
nav_order: 80
permalink: /master/search
content_type: how-to
redirect_from: ["/key-terms-and-features/search"]
source_path: docs/110-key-terms-and-features/030-search.md
tags: ["search"]
---
...
You can search through all golden records in CluedIn—just enter a keyword in the search box, and CluedIn will return all relevant results. Use [filters](/master/filters) to precisely define the golden records you're looking for based on various criteria.
...
1. Select **Save**.
    ...
    The search is saved in CluedIn. Now, you can use it when you need to quickly find a specific set of golden records or when you want to [clean](/govern/cleaning) those golden records.
