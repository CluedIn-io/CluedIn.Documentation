...
grand_parent: Master
nav_order: 70
permalink: /master/deduplication/tutorial-deduplicate-data
content_type: tutorial
redirect_from: ["/getting-started/data-deduplication"]
source_path: docs/010-getting-started/040-deduplication.md
...
The next item on the list of common data management tasks is data streaming. Now that your data has been cleaned and deduplicated, you can send it to a Microsoft SQL Server database. Learn how to send data from CluedIn to external systems in the [Stream data guide](/publish/streams/tutorial-stream-data).
