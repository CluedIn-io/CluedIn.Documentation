---
layout: cluedin
title: Plan the ingestion
parent: Data ingestion playbook
grand_parent: Playbooks
nav_order: 30
permalink: /playbooks/data-ingestion/plan-the-ingestion
content_type: concept
redirect_from: ["/playbooks/data-ingestion-playbook/ingest-data"]
source_path: docs/210-playbooks/data-ingestion/003-ingest-data.md
---
...
While ingesting your data, remember one of our project  principles—[start small](/playbooks/project-delivery/how-to-approach-your-cluedin-project). The idea is to **focus on one end-to-end data flow**, and not to load 10 million records at once as this will become a burden in the development phase of your project.
...
|--|--|
| File | [Link](/ingest/data-sources/file) to training video and documentation. |
| Endpoint | [Link](/ingest/data-sources/endpoint) to training video and documentation. |
| Database | [Link](/ingest/data-sources/database) to documentation. |
| Azure Data Factory | [Link](/solutions/azure-data-factory) to training video. |
| Microsoft Fabric/Azure Databricks | [Link](/solutions/fabric/connect-fabric-to-cluedin) to documentation. |
| Microsoft Purview | [Link](/solutions/purview) to documentation. |
| Crawler | [Link](/ingest/connectors/crawling) to documentation. |
...
Ensure that the required records are available on the **Preview** tab of the data set. Once the necessary data is ingested, you can start the [mapping process](/playbooks/data-ingestion/plan-the-mapping). 