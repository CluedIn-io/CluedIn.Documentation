...
content_type: how-to
source_path: docs/210-playbooks/007-data-transformation-playbook.md
---
...
Now that you have completed the [data ingestion](/playbooks/data-ingestion) process and generated some [golden records](/get-started/core-concepts/golden-records), it is time to start improving the quality of these records during data transformation.
...
- [Golden record](/get-started/core-concepts/golden-records)

- [Saved search](/master/search#saved-searches)

- [Glossary term](/govern/work-with-glossary)
