...
nav_order: 20
permalink: /playbooks/project-delivery/how-to-approach-your-cluedin-project
content_type: concept
redirect_from: ["/playbooks/how-to-approach-your-cluedin-project"]
source_path: docs/210-playbooks/002-how-to-approach-cluedin-project.md
---
...
One of our [guiding principles](/playbooks/project-delivery/before-you-start) is: "Aim for better data, not perfect data". Striving for 100% perfection from the start often leads to failure, which is why we advocate for an Agile approach. This allows for continuous improvement and adaptation.
