...
parent: Project delivery
grand_parent: Playbooks
nav_order: 50
permalink: /playbooks/project-delivery/start-your-it-journey
content_type: concept
redirect_from: ["/playbooks/start-your-it-journey"]
source_path: docs/210-playbooks/005-start-your-it-journey.md
---
...
- [CluedIn SaaS installation](/operate/deployment-options/saas)

- [Onboarding path for CluedIn SaaS](/get-started/get-cluedin#onboarding-path-for-cluedin-saas)
...
- [Pre-installation check](/operate/azure-marketplace/step-2)

- [Installation](/operate/azure-marketplace/step-3)

- [Post-installation](/operate/azure-marketplace/step-4)
...
- [CluedIn PaaS installation](/operate/deployment-options/azure-marketplace)

- [Onboarding path for CluedIn PaaS](/get-started/get-cluedin#onboarding-path-for-cluedin-paas)

- [CluedIn PaaS operations](/operate)