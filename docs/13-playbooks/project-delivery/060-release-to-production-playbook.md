...
nav_order: 60
permalink: /playbooks/project-delivery/release-to-production-playbook
content_type: concept
redirect_from: ["/playbooks/release-to-production-playbook"]
source_path: docs/210-playbooks/009-release-to-production-playbook.md
---
...
You can sync the configuration of your CluedIn instance between environments with the help of our **product toolkit** available in [Sync configuration between environments](/operate/configuration/sync-configuration-between-environments).

Learn which elements of CluedIn configuration can and cannot be synced in [Environment management playbook](/operate/operations/env-management-playbook).
