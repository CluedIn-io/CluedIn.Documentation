---
layout: cluedin
title: Example RACI matrix
parent: Project delivery
grand_parent: Playbooks
nav_order: 70
permalink: /playbooks/project-delivery/raci-example
content_type: reference
redirect_from: ["/playbooks/clued-vs-client-raci-example"]
source_path: docs/210-playbooks/130-vendorvsclientRACIexample.md
---
