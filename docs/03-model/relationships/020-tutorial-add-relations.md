...
grand_parent: Model
nav_order: 20
permalink: /model/relationships/tutorial-add-relations
content_type: tutorial
redirect_from: ["/getting-started/relations"]
source_path: docs/010-getting-started/090-relations.md
...
1. Ingested (uploaded, mapped, and processed) the data to which you will be linking the records. You can use file 1 above. See [Ingest data guide](/ingest/tutorial-ingest-data).

1. Uploaded and mapped the data that you will be linking to already existing records. You can use file 2 above. See [Import file](/ingest/tutorial-ingest-data#import-file) and [Create mapping](/ingest/tutorial-ingest-data#create-mapping).
...
1. Select **Finish** to save your changes.
    ...
    You added edge relations. To view relations between golden records, [process the data](/ingest/tutorial-ingest-data#process-data) and [stream the records](/publish/streams/tutorial-stream-data).
