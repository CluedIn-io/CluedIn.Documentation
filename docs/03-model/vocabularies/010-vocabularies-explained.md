...
grand_parent: Model
nav_order: 10
permalink: /model/vocabularies/vocabularies-explained
content_type: concept
redirect_from: ["/key-terms-and-features/vocabularies"]
source_path: docs/110-key-terms-and-features/110-vocabularies.md
...
- [Modeling approaches](/model/data-catalog/modeling-approaches)

- [Create and manage a vocabulary](/model/vocabularies/manage-vocabularies)

- [Create and manage vocabulary keys](/model/vocabularies/manage-vocabulary-keys)