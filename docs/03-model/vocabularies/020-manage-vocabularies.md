---
layout: cluedin
title: Create and manage vocabularies
parent: Vocabularies
grand_parent: Model
nav_order: 20
permalink: /model/vocabularies/manage-vocabularies
content_type: how-to
redirect_from: ["/management/data-catalog/vocabulary"]
source_path: docs/080-management/data-catalog/020-vocabulary.md
---
...
This tab contains groups of vocabulary keys associated with the vocabulary. You can search for specific keys or use [data type](/model/data-catalog/data-types) and classification filters to explore the available metadata within the vocabulary.

![vocabulary-keys.gif]({{ "/assets/images/management/data-catalog/vocabulary-keys.gif" | relative_url }})

For information on how to manage vocabulary keys, see [Vocabulary keys](/model/vocabularies/vocabulary-keys).
...
Depending on the selected [data modeling approach](/model/data-catalog/modeling-approaches), you can create a vocabulary in two ways:

- **Automatically** – this option is part of the data-first approach. When [creating a mapping](/ingest/mapping/create-mapping) for a data set, you have the option to enter the name of a new vocabulary. CluedIn will then automatically suggest the key prefix and generate the vocabulary. Once the mapping is created, you can then open the vocabulary and make any necessary adjustments.
