...
grand_parent: Model
nav_order: 50
permalink: /model/data-catalog/match-reference-data
content_type: how-to
redirect_from: ["/kb/how-to-match-reference-data"]
source_path: docs/200-kb/how-to/080-match-lookup-or-reference-data-automatically.md
---
