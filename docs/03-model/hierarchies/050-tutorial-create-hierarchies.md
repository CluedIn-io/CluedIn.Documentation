...
grand_parent: Model
nav_order: 50
permalink: /model/hierarchies/tutorial-create-hierarchies
content_type: tutorial
redirect_from: ["/getting-started/hierarchy-builder"]
source_path: docs/010-getting-started/070-hierarchy-builder.md
