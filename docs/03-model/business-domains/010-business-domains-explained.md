...
grand_parent: Model
nav_order: 10
permalink: /model/business-domains/business-domains-explained
content_type: concept
redirect_from: ["/key-terms-and-features/entity-type"]
source_path: docs/110-key-terms-and-features/090-entity-type.md
...
A business domain is assigned to a clue during the mapping process, and it plays a critical role in various [identifiers](/model/identifiers), including primary identifiers and additional identifiers.
...
- [Add or modify a business domain](/model/business-domains/manage-business-domains)