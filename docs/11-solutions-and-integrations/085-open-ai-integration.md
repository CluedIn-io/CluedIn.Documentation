...
nav_order: 85
permalink: /solutions/open-ai-integration
content_type: how-to
redirect_from: ["/microsoft-integration/open-ai-integration"]
source_path: docs/180-microsoft-integration/060-open-ai.md
---
