---
layout: cluedin
title: Power Apps features
parent: Power Apps
grand_parent: Solutions & integrations
nav_order: 50
permalink: /solutions/power-apps/features
content_type: concept
redirect_from: ["/microsoft-integration/powerapps/features"]
source_path: docs/180-microsoft-integration/powerapps/030-features.md
