---
layout: cluedin
title: "MDS to CluedIn: adoption and mindset"
parent: Use cases
grand_parent: Solutions & integrations
nav_order: 130
permalink: /solutions/use-cases/mds-to-cluedin-2
content_type: concept
redirect_from: ["/playbooks/mds-to-cluedin/02-adoption-and-mindset"]
source_path: docs/230-usecases/mds-to-cluedin/02-mds-to-cluedin-adoption-and-mindset.md
---
...
Next: [Part 3](/solutions/use-cases/mds-to-cluedin-3) is an FAQ + a worked example that maps typical MDS use cases into CluedIn patterns.
