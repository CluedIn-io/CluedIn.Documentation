---
layout: cluedin
title: "MDS to CluedIn: FAQ and worked example"
parent: Use cases
grand_parent: Solutions & integrations
nav_order: 140
permalink: /solutions/use-cases/mds-to-cluedin-3
content_type: concept
redirect_from: ["/playbooks/mds-to-cluedin/03-faq-mapping"]
source_path: docs/230-usecases/mds-to-cluedin/03-mds-to-cluedin-faq-mapping.md
---
...
Use the decision matrix in [Part 1](/solutions/use-cases/mds-to-cluedin-1). Most teams end up hybrid:
