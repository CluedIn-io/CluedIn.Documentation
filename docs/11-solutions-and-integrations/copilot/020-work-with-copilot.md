...
nav_order: 20
permalink: /solutions/copilot/work-with-copilot
content_type: how-to
redirect_from: ["/microsoft-integration/copilot-integration/work-with-copilot"]
source_path: docs/180-microsoft-integration/copilot/020-work-with-copilot.md
---
...
CluedIn Copilot can create all [types of rules](/govern/rules/rule-types)—data part rules, survivorship rules, and golden records rules—and apply any [rule action](/govern/rules/rules-reference).
