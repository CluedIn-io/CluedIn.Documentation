...
nav_order: 20
permalink: /solutions/azure-data-factory/copy-data
content_type: how-to
redirect_from: ["/microsoft-integration/adf-integration/copy-data"]
source_path: docs/180-microsoft-integration/azure-data-factory/002-copy-data-activity.md
---
...
1. In the **New linked service** pane, provide the following details:
    ...
    - **Base URL** – enter the URL of the ingestion endpoint in CluedIn. For more information, see [Send data](/ingest/data-sources/endpoint#send-data).
    ...
    - **Auth headers** – add a new header with the following details:
        ...
        - **Value** – enter **Bearer**, add a space, and then paste the token from CluedIn. For more information, see [Send data](/ingest/data-sources/endpoint#send-data).
