...
nav_order: 20
permalink: /solutions/fabric/connect-fabric-to-cluedin
content_type: how-to
redirect_from: ["/microsoft-integration/fabric/connect-fabric-to-cluedin"]
source_path: docs/180-microsoft-integration/fabric/020-connect-fabric-to-cluedin.md
---
...
- An endpoint in CluedIn. You can find instructions on how to create an endpoint [here](/ingest/data-sources/endpoint). After you create an endpoint, you'll find the POST URL.
...
1. In CluedIn, create auto-mapping for the data set following the instructions [here](/ingest/mapping/create-mapping).

1. In CluedIn, edit the mapping for the data set to select the property used as the entity name and the property used for the primary identifier. For more information about mapping details, see [Review mapping](/ingest/mapping/review-mapping).
