...
nav_order: 90
permalink: /solutions/excel-add-in
content_type: how-to
redirect_from: ["/microsoft-integration/excel-add-in"]
source_path: docs/180-microsoft-integration/090-excel-add-in.md
---
...
- **Create Entity Type** – opens the business domain (previously entity type) creation pane in CluedIn in your default browser. For more information, see [Create business domain](/model/business-domains/manage-business-domains#create-a-business-domaine).
