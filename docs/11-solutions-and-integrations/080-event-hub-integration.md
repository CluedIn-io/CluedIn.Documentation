...
nav_order: 80
permalink: /solutions/event-hub-integration
content_type: how-to
redirect_from: ["/microsoft-integration/event-hub-integration"]
source_path: docs/180-microsoft-integration/050-event-hub.md
---
