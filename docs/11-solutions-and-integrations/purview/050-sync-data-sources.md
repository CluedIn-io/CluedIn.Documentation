...
nav_order: 50
permalink: /solutions/purview/sync-data-sources
content_type: how-to
redirect_from: ["/microsoft-integration/purview/sync-data-sources"]
source_path: docs/180-microsoft-integration/purview/030-sync-data-sources.md
...
1. Select the default **Domain** that contains the collections you created in [Create a new collection](/solutions/purview/pre-configuration-guide#create-a-new-collection).
