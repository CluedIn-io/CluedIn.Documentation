...
nav_order: 150
permalink: /solutions/purview/sync-data-products
content_type: how-to
redirect_from: ["/microsoft-integration/purview/sync-data-products"]
source_path: docs/180-microsoft-integration/purview/120-sync-data-products.md
...
In this article, you will learn how to sync Purview data products and data assets into CluedIn data sources. This feature works only if Azure Data Factory (ADF) automation is enabled and configured. For more information, see [Azure Data Factory pipeline automation](/solutions/purview/data-factory-pipeline-automation).
