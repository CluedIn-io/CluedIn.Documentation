...
nav_order: 120
permalink: /solutions/purview/sync-streams-to-purview
content_type: how-to
redirect_from: ["/microsoft-integration/purview/sync-streams-to-purview"]
source_path: docs/180-microsoft-integration/purview/090-sync-streams-to-purview.md
