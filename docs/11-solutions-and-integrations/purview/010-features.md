---
layout: cluedin
title: Purview integration features
parent: Microsoft Purview
grand_parent: Solutions & integrations
nav_order: 10
permalink: /solutions/purview/features
content_type: concept
redirect_from: ["/microsoft-integration/purview/introduction"]
source_path: docs/180-microsoft-integration/purview/010-intro.md
...
![Example of a Data Set lineage](/assets/images/microsoft-integration/purview/media/dataset_lineage.png)
...
![Purview glossary terms created under the root glossary term "CluedIn" + [Your machine name], ex. "CluedIn-Dell"](/assets/images/microsoft-integration/purview/media/vocab_to_glossary.png)
...
![Example of a Crawler lineage](/assets/images/microsoft-integration/purview/media/crawler_lineage.png)
...
![Example of a Enricher lineage](/assets/images/microsoft-integration/purview/media/enricher_lineage.png)
...
![CluedIn ADF Copy Data Automation Dataset](/assets/images/microsoft-integration/purview/media/adf_copy.png)
