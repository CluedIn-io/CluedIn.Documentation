...
nav_order: 10
permalink: /archive/legacy-development/modelling
content_type: reference
redirect_from: ["/development/modelling"]
source_path: docs/090-development/010-modelling.md
...
- [Installing an existing integration](/ingest/connectors/install-integrations)
...
There are many *providers* available in our [GitHub](https://github.com/CluedIn-io), but alternatively you can also [build your own](/develop/integrations/build-integration) to cater for your specific requirements. In order to do this though, you will require some C# coding experience.
