...
nav_order: 130
permalink: /archive/legacy-development/validate-server-health
content_type: reference
redirect_from: ["/development/validate-server-health"]
source_path: docs/090-development/150-validate-server-health.md
