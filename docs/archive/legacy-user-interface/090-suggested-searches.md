...
nav_order: 90
permalink: /archive/legacy-user-interface/suggested-searches
content_type: reference
redirect_from: ["/user-interface/suggested-searches"]
source_path: docs/100-user-interface/090-suggested-searches.md
tags: ["ui","search"]
