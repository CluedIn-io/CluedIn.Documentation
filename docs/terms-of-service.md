...
source_path: docs/240-terms-of-service.md
nav_exclude: true
---
...
For CluedIn [SaaS customers](/get-started/get-cluedin#onboarding-path-for-cluedin-saas), CluedIn provides a dedicated service level agreement (SLA), which specifies our commitments to service availability, uptime, and support response times.
