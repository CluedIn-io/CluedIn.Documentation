...
grand_parent: Ingest
nav_order: 20
permalink: /ingest/connectors/crawling
content_type: concept
redirect_from: ["/integration/crawling"]
source_path: docs/040-integration/crawlers/020-crawling.md
...
- [ ] Filtering to get only the latest data (delta/auto crawls) – By default, CluedIn runs a job every 4 hours for a new crawl. This should only pull changes since the last crawl. For details, see [Delta/Auto crawls – Change Data Capture](/develop/integrations/delts-crawls).
