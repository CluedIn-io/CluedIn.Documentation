...
grand_parent: Ingest
nav_order: 10
permalink: /ingest/connectors/about-integrations
content_type: concept
redirect_from: ["/integration/introduction"]
source_path: docs/040-integration/crawlers/010-introduction.md
tags: ["integration"]
...
- [Install an existing integration](/ingest/connectors/install-integrations)
...
There are many providers available in our [GitHub repository](https://github.com/CluedIn-io). You can also [build your own providers](/develop/integrations/build-integration), but this requires C# coding experience.
...
We have a list of available enrichers in our [GitHub repository](https://github.com/CluedIn-io?q=enricher&type=public). You can also [build your own enrichers](/develop/build-custom-enricher) if you have some C# coding experience.
