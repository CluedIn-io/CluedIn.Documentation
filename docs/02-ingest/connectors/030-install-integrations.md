...
grand_parent: Ingest
nav_order: 30
permalink: /ingest/connectors/install-integrations
content_type: how-to
redirect_from: ["/integration/install-integrations"]
source_path: docs/040-integration/crawlers/100-install-integration.md
tags: ["integration"]
---
