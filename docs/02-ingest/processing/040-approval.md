...
grand_parent: Ingest
nav_order: 40
permalink: /ingest/processing/approval
content_type: how-to
redirect_from: ["/integration/additional-operations-on-records/approval"]
source_path: docs/040-integration/additional-operations-on-records/050-approval.md
...
- [Property rules](/ingest/mapping/property-rules) – use to define the conditions for sending the source record for approval based on the property values of the record.

- [Pre-process rules](/ingest/mapping/preprocess-rules) – use to define the conditions for sending the source record for approval based on the whole record, and not its specific property values.

- [Advanced mapping code](/ingest/mapping/advanced-mapping-code) – use to define complex logic for sending the source record for approval.
...
Source record approval is useful for [manual data entry projects](/ingest/manual-data-entry) as it grants project owners full control over the records created in the project. The owners of the manual data entry project can review new records added by non-owner users and decide whether they should be processed and turned into golden records.
...
- You should be added to the **Permissions** tab of the data source. This is necessary to view source records. For more information about access to data, see [Source control](/administer/users-and-roles/data-access#source-control).

- You should be added to the **Owners** tab of the data set. This is necessary to approve or reject source records. For more information about the right to approve and reject, see [Ownership](/administer/users-and-roles/feature-access#ownership).
