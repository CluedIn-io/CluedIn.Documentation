...
grand_parent: Ingest
nav_order: 30
permalink: /ingest/troubleshooting/monitoring
content_type: how-to
redirect_from: ["/integration/additional-operations-on-records/monitoring"]
source_path: docs/040-integration/additional-operations-on-records/070-monitoring.md
