...
grand_parent: Ingest
nav_order: 20
permalink: /ingest/troubleshooting/logs
content_type: how-to
redirect_from: ["/integration/additional-operations-on-records/logs"]
source_path: docs/040-integration/additional-operations-on-records/060-logs.md
