...
layout: cluedin
title: Quarantine
parent: Troubleshoot ingestion
grand_parent: Ingest
nav_order: 10
permalink: /ingest/troubleshooting/quarantine
content_type: how-to
redirect_from: ["/integration/additional-operations-on-records/quarantine"]
source_path: docs/040-integration/additional-operations-on-records/040-quarantine.md
...
- [Pre-process rules](/ingest/mapping/preprocess-rules)

- [Property rules](/ingest/mapping/property-rules)

- [Schema protection](/ingest/data-sources/endpoint#schema-protection)
...
If a record is quarantined due to the [Schema Protection feature](/ingest/data-sources/endpoint#schema-protection), it will be automatically released from quarantine if you disable the feature.
