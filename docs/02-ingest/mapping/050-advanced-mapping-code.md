...
grand_parent: Ingest
nav_order: 50
permalink: /ingest/mapping/advanced-mapping-code
content_type: reference
redirect_from: ["/integration/additional-operations-on-records/advanced-mapping-code"]
source_path: docs/040-integration/additional-operations-on-records/030-advanced-mapping.code.md
...
In this article, you will learn about the possibility of introducing changes to your [clues](/get-started/core-concepts/clue-reference) using JavaScript glue code. You can perform similar actions as with [property](/ingest/mapping/property-rules) and [pre-process](/ingest/mapping/preprocess-rules) rules but you gain greater flexibility to set up complex conditions.
