...
grand_parent: Ingest
nav_order: 10
permalink: /ingest/data-sources/define-data-to-ingest
content_type: concept
redirect_from: ["/integration/define-data-to-ingest"]
source_path: docs/040-integration/data-sources/130-define-data-to-ingest.md
tags: ["integration"]
...
{:.important}
Regardless of the data ingestion method you choose, the [processing](/ingest/processing/process-data) of data is the same across all sources.