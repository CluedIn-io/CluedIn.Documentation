...
grand_parent: Ingest
nav_order: 40
permalink: /ingest/data-sources/database
content_type: how-to
redirect_from: ["/integration/database"]
source_path: docs/040-integration/data-sources/160-database.md
tags: ["integration"]
...
1. Select the checkboxes next to the tables you want to ingest into CluedIn. Then, in the lower-right corner, select **Add**.
    ...
    The tables are added to CluedIn. Each table is added as a separate data set. Next, [create mapping](/ingest/mapping/create-mapping) and [process data](/ingest/processing/process-data).