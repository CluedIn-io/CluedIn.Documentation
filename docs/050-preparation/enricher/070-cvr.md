...
- **Authentication** – modify the details you provided while configuring the enricher: **Accepted Business Domain**, **Organization Name Vocab Key**, **Organization Name Normalization**, **CVR Vocab Key**, **Country Vocab Key**, **Website Vocab Key**.
