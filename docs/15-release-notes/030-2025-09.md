...
source_path: docs/160-release/004-release-2025-09.md
---
...
For more information, see [AI agents](/govern/ai-agents).
...
For more information, see [Tag monitoring](/govern/tags/tag-monitoring).
...
For more information, see [Golden record relations](/master/golden-records/golden-record-relations).
...
- [Apply a rule to all records](/govern/rules/create-rule#apply-a-rule-to-all-records)
- [View rule execution logs](/govern/rules/create-rule#view-rule-execution-logs)
...
For more information, see [Process cleaned data](/govern/cleaning/manage-clean-project#process-cleaned-data).
...
For more information, see [Schema protection](/ingest/data-sources/endpoint#schema-protection).
...
- Modules that you haven't used yet feature onboarding videos to help you get started. You can revisit the videos anytime on the [documentation portal](/get-started/quick-feature-tour).

    ![nav_menu_onboarding_video.png](/assets/images/release/Release 2025.09/nav_menu_onboarding_video.png)

For more information, see [Side navigation menu](/administer/ui-configuration/side-navigation-menu).
