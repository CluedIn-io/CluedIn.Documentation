...
source_path: docs/160-release/006-release-2026-02.md
---
...
The **2026.02 release** is a focused update centered on improving the stability, reliability, and overall quality of the CluedIn platform. While much of the work has gone into resolving issues and enhancing performance behind the scenes, we've also introduced a selection of new features and usability improvements that provide greater flexibility and a smoother user experience.
