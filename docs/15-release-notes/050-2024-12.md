...
source_path: docs/160-release/001-release-2024-12.md
...
To access new home dashboard, turn on the corresponding feature [flag](/administer/feature-flags).

![Home_dashboard_feature_flag.png]({{ "/assets/images/release/Home_dashboard_feature_flag.png" | relative_url }})
...
- [Data access](/administer/users-and-roles/data-access) – here, you'll find details about the combination of source control and access control.

- [Access control](/administer/access-control) – here, you'll find instructions on how to create and configure an access control policy.
...
- [Roles](/administer/users-and-roles/roles) – here, you'll find a list of all CluedIn roles and an explanation of claims and access levels.

- [Feature access](/administer/users-and-roles/feature-access) – here, you'll learn about the main settings that define access to CluedIn features: roles and ownership.

- [Claims](/administer/users-and-roles/claims) – here, you'll find detailed explanation of each claim used in CluedIn. 

To view role access status, turn on the corresponding feature flag.

![Role_access_status_feature_flag.png]({{ "/assets/images/release/Role_access_status_feature_flag.png" | relative_url }})

## Exporting golden records

After performing a search, you can now export your results in one of the following formats: JSON, CSV, XLSX, or Parquet. For more information, see [Export search results](/master/search#export-search-results).

To access the golden records export feature, turn on the corresponding feature flag.

![Exporting_golden_records_feature_flag.png]({{ "/assets/images/release/Exporting_golden_records_feature_flag.png" | relative_url }})
...
![Workflow_feature_flag.png]({{ "/assets/images/release/Workflow_feature_flag.png" | relative_url }})

For more information on how to configure and use workflows, see [Workflows](/govern/workflows).

## Deleting data parts and golden records

Previously, you could delete data parts by data source, which resulted in removing those data parts from every golden record where they were used. Now, you can delete individual data parts from a specific golden record. For more information, see [Delete individual data parts](/master/golden-records/delete-data-parts-from-golden-records).

In addition, now you can also delete a golden record. However, keep in mind that deleting golden records is permanent and irreversible, so carefully consider which golden records you want to delete. For more information, see [Delete golden records](/master/golden-records/delete-golden-records).

## History of golden record relations

Now, you can view all outgoing relations for a golden record on the **History** tab. Here, you can view edge properties, filter edges by type or property, easily find edge details, or delete an edge if you no longer need it. For more information, see [History](/master/golden-records/history)

![History_relations.png]({{ "/assets/images/release/History_relations.png" | relative_url }})
...
![preview-filters-and-operations-1.png]({{ "/assets/images/integration/additional-operations/preview-filters-and-operations-1.png" | relative_url }})

For more information, see [Data set filters and operations](/ingest/processing/preview#data-set-filters-and-operations).
...
- [Azure Data Lake connector](/publish/export-targets/adl-connector) – here, you'll find the prerequisites and instructions for configuring the Azure Data Lake connector.

- [OneLake connector](/publish/export-targets/onelake-connector) – here, you'll find the prerequisites and instructions for configuring the OneLake connector.
...
- **Documentation** – here, you can find links to the most important articles for each CluedIn module. To get access to documentation, turn on the **Knowledge Hub** feature flag.
    ...
    ![Knowledge_hub_feature_flag.png]({{ "/assets/images/release/Knowledge_hub_feature_flag.png" | relative_url }})
...
- **Videos** – here, you'll find webinars, events, and discussions on various topics.
    ...
    ![CluedIn_news_feature_flag.png]({{ "/assets/images/release/CluedIn_news_feature_flag.png" | relative_url }})
...
![Help_panel.png]({{ "/assets/images/release/Help_panel.png" | relative_url }})

## Duplicate actions

Now you can easily duplicate [clean projects](/govern/cleaning/manage-clean-project#duplicate-a-clean-project), [rules](/govern/rules/manage-rules#duplicate-a-rule), [deduplication projects](/master/deduplication/manage-a-deduplication-project#duplicate-a-deduplication-project), [streams](/publish/streams/manage-streams#duplicate-a-stream), glossary terms, and more. This action allows you to create new elements in CluedIn using the configurations of the existing elements.
