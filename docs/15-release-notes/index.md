...
source_path: docs/170-release-notes.md
---

<div class="audience">
  <p class="audience-question">What changed, and what is supported?</p>
  <p class="audience-who">Everyone.</p>
</div>

What shipped in each release, and how CluedIn versions and supports the platform.
