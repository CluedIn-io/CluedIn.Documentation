...
const CATEGORIES = [
  { slug: 'system', title: 'System & health',
    description: 'Status, health, and platform-level endpoints used to verify connectivity and probe the running environment.',
    tags: ['Status','HealthLiveness','HealthReadiness','DefaultRedirect','RobotsTxt'] },
  ...
  { slug: 'entities', title: 'Entities',
    ...
    tags: ['Entity','EntityActions','EntityDataDeletion','EntityHistory','EntityInfo','EntityModification','EntityOrigin','EntitySource','EntityTopology','EntityTypeInfo','AdminEntity','DuplicateEntities','SplitEntity','IdentityCounter'] },
  { slug: 'search', title: 'Search',
    description: 'Query the CluedIn graph and manage saved, suggested, and autocomplete searches.',
    tags: ['Search','SavedSearch','SuggestedSearch','RulesAutoComplete','SearchToClean'] },
  { slug: 'vocabularies', title: 'Vocabularies',
    description: 'Manage vocabularies, vocabulary keys, and the strong-typing system that underpins them.',
    tags: ['Vocabulary','VocabularyUsage','StrongTyping'] },
  ...
  { slug: 'rules-and-evaluation', title: 'Rules & evaluation',
    ...
    tags: ['Rules','RuleDataPreview','RuleErrorLog','Evaluation','ExplainLog'] },
  { slug: 'data-ingestion', title: 'Data ingestion',
    description: 'Data sources, file uploads, onboarding, jobs, and crawlers for getting data into CluedIn.',
    tags: ['DataSource','Import','Integration','Blob','OrganizationUpload','Onboarding','Job','DistributedJobs','AdminDistributedJobs','AdminCrawler','AdminDeadLetterQueue','OrganizationAdminCrawler','OrganizationDataRemoval'] },
  { slug: 'streams-and-export', title: 'Streams, connectors & export',
    ...
    tags: ['Streams','StreamIngestionLog','StreamLog','StreamMappings','StreamsVocabularyKeyUsage','Connector','ConnectorHealth','DataverseConnector','Export'] },
  { slug: 'data-preparation-and-enrichment', title: 'Data preparation & enrichment',
    description: 'Clean and enrich records using built-in cleaning, the CluedIn clean service, and enricher providers.',
    tags: ['Clean','CluedInClean','Enricher','Enrichers','ExternalFeature'] },
  { slug: 'workflow-and-automation', title: 'Workflow & automation',
    ...
    tags: ['Automate','PowerAutomate','EnterpriseFlows','Task','TaskApproval','TaskRoleRequest','ApprovalItem','MeshCenter','MeshProcessor'] },
  { slug: 'ai', title: 'AI',
    description: 'AI agents, jobs, skills, endpoints, deployments, and Copilot.',
    tags: ['AIAgent','AiDeployment','AiEndpoint','AiJob','AiJobSkill','AiPlatform','AiPlatformDefinition','Copilot','LanguageServer'] },
  { slug: 'administration-and-configuration', title: 'Administration & configuration',
    description: 'Cluster settings, admin commands, index commands, configuration, logging, and metered billing.',
    tags: ['AdminClusterSettings','AdminCommands','AdminIndexCommands','Configuration','ExtendedConfiguration','Setting','Logging','Log','MeteredBilling'] },
  { slug: 'organization', title: 'Organization',
    description: 'Organization profile, provider configuration, and team broadcasts.',
    tags: ['Organization','OrganizationProfile','OrganizationAdminCommands','OrganizationAddProviders','OrganizationUpdateProviders','OrganizationEnableProviders','OrganizationGetProviders','OrganizationProviderStatus','OrganizationTeamBroadcast'] },
  { slug: 'insights-and-ui', title: 'Insights & UI',
    description: 'Insights, widgets, page and layout templates, notifications, profiles, and other endpoints used by the CluedIn UI.',
    tags: ['Insight','GenericWidget','WidgetQuery','PageTemplate','PageTemplateEntities','LayoutTemplate','TagMetadata','Activities','Notification','NotificationV2','Profile','Person','Project','Results'] }
];
