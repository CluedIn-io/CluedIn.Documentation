...
docker run --name CluedIn.Documentation --rm -e "JEKYLL_ENV=docker" --volume="${PWD}:/srv/jekyll" --publish 4000:4000 --publish 35729:35729 jekyll/jekyll bash -c "gem install bundler:2.2.27 && jekyll serve -w --livereload --force_polling --config _config.yml,_config.docker.yml"